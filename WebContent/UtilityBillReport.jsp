                    ...
                    <tbody>
                     ...
                     <%
                       ...
                       ResultSet rs = null;
                        ...
                        sql ="SELECT * FROM hotelmanage.utilitybills  WHERE AddedDate > '"+sqdob+"' AND  AddedDate <'"+sqdob1+"'  ORDER BY BillType";
                        ...
                        while(rs.next()){
                            ...
                            <tr>
                             ...
                             <th scope="row"><%=rs.getString("BillID") %></th>                                                  
